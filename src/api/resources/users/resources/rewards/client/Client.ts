    ...
    private async __offers(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                ...
                `/v2/issuers/${encodeURIComponent(organizationId)}/users/${encodeURIComponent(userId)}/offers`,
            ),
            method: "GET",
            headers: {
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.KardApiEnvironment.Production,
                `/v2/issuers/${encodeURIComponent(organizationId)}/users/${encodeURIComponent(userId)}/locations`,
            ),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
