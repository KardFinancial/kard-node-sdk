...
export class RewardsClient {
    ...
    public placementOffers(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__placementOffers(organizationId, userId, placementId, request, requestOptions),
        );
    }

    private async __placementOffers(
        organizationId: KardApi.OrganizationId,
        userId: KardApi.UserId,
        placementId: string,
        request: KardApi.users.GetOffersByPlacementRequest = {},
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.KardApiEnvironment.Production,
                `/v2/issuers/${core.url.encodePathParam(organizationId)}/users/${core.url.encodePathParam(userId)}/placements/${core.url.encodePathParam(placementId)}/offers`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: { ..._queryParams, ...requestOptions?.queryParams },
     ...
     */
    public placementBatches(
        organizationId: KardApi.OrganizationId,
        userId: KardApi.UserId,
        placementId: string,
        request: KardApi.users.GetBatchesByPlacementRequest = {},
        requestOptions?: RewardsClient.RequestOptions,
    ): core.HttpResponsePromise<KardApi.users.BatchesResponseObject> {
        return core.HttpResponsePromise.fromPromise(
            this.__placementBatches(organizationId, userId, placementId, request, requestOptions),
        );
    }

    private async __placementBatches(
        organizationId: KardApi.OrganizationId,
        userId: KardApi.UserId,
        placementId: string,
        request: KardApi.users.GetBatchesByPlacementRequest = {},
        requestOptions?: RewardsClient.RequestOptions,
    ): Promise<core.WithRawResponse<KardApi.users.BatchesResponseObject>> {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.KardApiEnvironment.Production,
                `/v2/issuers/${core.url.encodePathParam(organizationId)}/users/${core.url.encodePathParam(userId)}/placements/${core.url.encodePathParam(placementId)}/batches`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: { ..._queryParams, ...requestOptions?.queryParams },
        ...
        if (_response.ok) {
            return { data: _response.body as KardApi.users.BatchesResponseObject, rawResponse: _response.rawResponse };
        }
