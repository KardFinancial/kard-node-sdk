...
export class FilesClient {
     ...
     * @param {KardApi.SaveFilesMetadataRequest} request
     ...
     *     })
     */
    public internalSaveFile(
        organizationId: KardApi.OrganizationId,
        request: KardApi.SaveFilesMetadataRequest,
        requestOptions?: FilesClient.RequestOptions,
    ): core.HttpResponsePromise<KardApi.SaveFilesMetadataResponseObject> {
        return core.HttpResponsePromise.fromPromise(this.__internalSaveFile(organizationId, request, requestOptions));
    }

    private async __internalSaveFile(
        organizationId: KardApi.OrganizationId,
        request: KardApi.SaveFilesMetadataRequest,
        requestOptions?: FilesClient.RequestOptions,
    ): Promise<core.WithRawResponse<KardApi.SaveFilesMetadataResponseObject>> {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `internal/files/issuers/${core.url.encodePathParam(organizationId)}/metadata`,
            ),
            method: "POST",
            headers: _headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as KardApi.SaveFilesMetadataResponseObject,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KardApiTimeoutError(
                    "Timeout exceeded when calling POST /internal/files/issuers/{organizationId}/metadata.",
                );
            case "unknown":
                throw new errors.KardApiError({
