...
export class Eligibility {
     ...
     * @param {KardApi.GetOffersByUserRequest} request
    ...
    ): core.HttpResponsePromise<KardApi.OffersResponseObject> {
        return core.HttpResponsePromise.fromPromise(
            this.__getOffersByUser(organizationId, userId, request, requestOptions),
        );
    }

    private async __getOffersByUser(
        organizationId: KardApi.OrganizationId,
        userId: KardApi.UserId,
        request: KardApi.GetOffersByUserRequest = {},
        requestOptions?: Eligibility.RequestOptions,
    ): Promise<core.WithRawResponse<KardApi.OffersResponseObject>> {
        const {
            "page[size]": pageSize,
        ...
        if (_response.ok) {
            return { data: _response.body as KardApi.OffersResponseObject, rawResponse: _response.rawResponse };
        }
     ...
     * @param {KardApi.OrganizationId} organizationId
     * @param {KardApi.UserId} userId
     * @param {KardApi.GetLocationsByUserRequest} request
     * @param {Eligibility.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link KardApi.InternalServerError}
     * @throws {@link KardApi.InvalidRequest}
    ...
    public getLocationsByUser(
        ...
        requestOptions?: Eligibility.RequestOptions,
    ): core.HttpResponsePromise<KardApi.LocationsResponseObject> {
        return core.HttpResponsePromise.fromPromise(
            this.__getLocationsByUser(organizationId, userId, request, requestOptions),
        );
    }

    private async __getLocationsByUser(
        organizationId: KardApi.OrganizationId,
        userId: KardApi.UserId,
        request: KardApi.GetLocationsByUserRequest = {},
        requestOptions?: Eligibility.RequestOptions,
    ): Promise<core.WithRawResponse<KardApi.LocationsResponseObject>> {
        const {
            "page[size]": pageSize,
            "page[after]": pageAfter,
            "page[before]": pageBefore,
        ...
        if (_response.ok) {
            return { data: _response.body as KardApi.LocationsResponseObject, rawResponse: _response.rawResponse };
        }
