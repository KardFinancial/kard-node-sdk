...
export class AuthClient {
    ...
    /**
     * @param {KardApi.GetTokenRequest} request
    ...
    ): core.HttpResponsePromise<KardApi.TokenResponse> {
    ...
    private async __getToken(
        ...
        if (_response.ok) {
            return { data: _response.body as KardApi.TokenResponse, rawResponse: _response.rawResponse };
        }
