...
describe("TransactionsClient", () => {
    ...
    test("createBulkTransactionsUploadUrl (1)", async () => {
        const server = mockServerPool.createServer();
        const client = new KardApiClient({
            maxRetries: 0,
            clientId: "client_id",
        ...
        const rawRequestBody = {
            data: [
                { type: "incomingTransactionsFile", attributes: { filename: "transaction_12345.jsonl" } },
                { type: "incomingTransactionsFile", attributes: { filename: "transaction_67890.jsonl" } },
            ],
        };
        const rawResponseBody = {
            data: [
                ...
                },
                {
                    ...
                    attributes: { url: "https://s3.amazonaws.com/bucket/key2?X-Amz-Algorithm=...", expiresIn: 900 },
                },
            ],
        };
    ...
    test("createBulkTransactionsUploadUrl (2)", async () => {
        const server = mockServerPool.createServer();
        const client = new KardApiClient({
            maxRetries: 0,
            clientId: "client_id",
        ...
        await expect(async () => {
            return await client.transactions.createBulkTransactionsUploadUrl("organizationId", {
                data: [
                    {
                        type: "incomingTransactionsFile",
                        attributes: {
